...
public class ManagementDAO extends JobDAO{
    ...
    public boolean applicationExists(int idWorker, int idJob){
        ...
        try {
            PreparedStatement getApplicationSet = connection.prepareStatement("SELECT * FROM managementapplications WHERE idWorker = ? AND idManagementJob = ?");
    ...
    public void createApplication(String workerName, Job job){
        ...
        try {
            ...
            PreparedStatement addApplication = connection.prepareStatement("INSERT INTO managementapplications (idWorker, idManagementJob) VALUES (?, ?)");
    ...
    public void hireWorker(Worker worker, Job job){
        ...
        try{
            // hiring the worker
            PreparedStatement hireWorker = connection.prepareStatement("INSERT INTO managementoccupations (idWorker, idManagementJob) VALUES (?, ?)");
            ...
            PreparedStatement clearApps = connection.prepareStatement("DELETE FROM managementapplications WHERE idManagementJob = ?");
            ...
            PreparedStatement clearApps4 = connection.prepareStatement("DELETE FROM applications WHERE idWorker = ?");
